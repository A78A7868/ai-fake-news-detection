...
\IEEEauthorblockA{\textit{Indian Institute of Computing and Technology (IICT)} \\
...
\begin{IEEEkeywords}
Artificial Intelligence, Machine Learning, Natural Language Processing, Fake News Detection, Text Classification.
\end{IEEEkeywords}
...
\bibitem{isot} Bisaillon, C. (2020), ``Fake and Real News Dataset,'' Kaggle. [Online]. Available: https://www.kaggle.com/datasets/clmentbisaillon/fake-and-real-news-dataset
